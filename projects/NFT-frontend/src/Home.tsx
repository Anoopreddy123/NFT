    ...
    return (
        <div className="hero min-h-screen">
            <a-scene>
                ...
                {/* Buttons */}
                <a-box position="-2.5 1.5 -3" color="#000000" width="2" height="1" depth="0.1" onClick={toggleModal(setWalletModalOpen)}>
                    <a-text value="Wallet Connection" align="center" color="white" width="4" position="0 0 0.05"></a-text>
                </a-box>

                {activeAddress && (
                    <a-box position="0 1.5 -3" color="#000000" width="2" height="1" depth="0.1" onClick={toggleModal(setDemoModalOpen)}>
                        <a-text value="Send Transaction" align="center" color="white" width="4" position="0 0 0.05"></a-text>
                    </a-box>
                )}

                {activeAddress && (
                    <a-box position="2.5 1.5 -3" color="#000000" width="2" height="1" depth="0.1" onClick={toggleModal(setTransactionModalOpen)}>
                        <a-text value="Show Transactions" align="center" color="white" width="4" position="0 0 0.05"></a-text>
                    </a-box>
                )}

                {activeAddress && (
                    <a-box position="-2.5 0 -3" color="#000000" width="2" height="1" depth="0.1" onClick={toggleModal(setNFTMarketplaceModalOpen)}>
